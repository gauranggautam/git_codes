...
X_START, X_END, Y_START, Y_END, F_START, F_END, STEP = x_now-scsize, x_now+scsize, y_now-scsize, y_now+scsize, f_now-scsize, f_now+scsize, 0.1
...
print(f'\nMoved to max: ({best_x:.2f}, {best_y:.2f}), adjusting focus now...')
amc.control.setControlOutput(1, True); amc.control.setControlMove(1, True)
